...
// import { DeleteMenDataAsync, filterData, GetAllWomenAsync } from '../Services/Action/Action';
...
// const Women = () => {
//     const { men } = useSelector(state => state.ReducerData);
...
//                     <div className="row">
//                         <h3 className='text-center mb-4'>WOMEN'S COLLECTION</h3>
//                         <div className="col-3">
