...
//         dispatch(DeleteWomenDataAsync (id));
//     };
...
import { useDispatch, useSelector } from 'react-redux';
import { DeleteWomenDataAsync, filterData, GetAllWomenAsync } from '../Services/Action/Action';
              ...
              <div className="col-7 col-lg-9 p-0">
                <div className='men-card'>
                  <div className='row'>
                    {men.map((v) => (
                      <div key={v.id} className='col-12 col-lg-4'>
                        <div className='mens-card' style={{ position: 'relative' }}>
                          ...
                          <div className='men-card-content p-2'>
                            ...
                            <p className='mb-0' style={{ color: "grey", fontSize: "1.1rem" }}>{v.desc}</p>
                            <p className='mb-0' style={{ color: "black", fontSize: "1.1rem" }}>₹ {v.price}</p>
                            <div className='d-flex gap-2 mt-2 action-buttons' style={{ zIndex: 20 }}>
                              {user && (
                                <>
                                  <button
                                    type="button"
